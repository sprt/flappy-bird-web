...
2,width:this.sprite.data.pipe_up.width,height:this.sprite.data.pipe_up.height}}};c.prototype.drawPipes=function(){var a=this;this.pipePairs.map(this.getPipeData.bind(this)).forEach(function(b){a.drawTile("pipe_down",b.down.x,b.down.y);a.drawTile("pipe_up",b.up.x,b.up.y)})};var n,p;480>g.innerWidth?(document.body.style.margin="0",n=g.innerWidth,p=g.innerHeight):(n=640,p=480);new c("#flappy-bird",n,p)})(window);
